...
const DECISION_COPY = {
  th: {
    ...
    highlightTitle: "คัดมาให้แล้ว",
    highlightSubtitle: "ที่เที่ยวและร้านเด่นในอุบล ที่อยากให้ได้ลองสักครั้ง",
    situationsTitle: "เลือกตามสไตล์การเที่ยว",
    situationsSubtitle: "เลือกสถานการณ์ที่ใช่ แล้วดูที่เที่ยวที่เข้ากับคุณ",
    situationEmpty: "ยังไม่ได้คัดที่เที่ยวสำหรับสถานการณ์นี้",
    situationSeeAll: "ดูทั้งหมด",
  ...
  en: {
    ...
    highlightTitle: "Hand-picked for you",
    highlightSubtitle: "Standout places and shops in Ubon worth trying at least once",
    situationsTitle: "Pick Your Style",
    situationsSubtitle: "Choose the situation that fits, then see the places that match",
    situationEmpty: "No places picked for this situation yet",
    situationSeeAll: "See all",
  ...
  zh: {
    ...
    highlightTitle: "精选推荐",
    highlightSubtitle: "乌汶值得一试的精选景点与店家",
    situationsTitle: "按旅行风格选择",
    situationsSubtitle: "选择合适的情境，找到适合你的去处",
    situationEmpty: "尚未为此情境挑选地点",
    situationSeeAll: "查看全部",
    trendingEvents: "新活动",
  ...
  lo: {
    ...
    highlightTitle: "ຄັດເລືອກມາໃຫ້ແລ້ວ",
    highlightSubtitle: "ບ່ອນທ່ຽວແລະຮ້ານເດັ່ນໃນອຸບົນ ທີ່ຢາກໃຫ້ໄດ້ລອງເທື່ອໜຶ່ງ",
    situationsTitle: "ເລືອກຕາມສະໄຕລ໌ການທ່ອງທ່ຽວ",
    situationsSubtitle: "ເລືອກສະຖານະການທີ່ເໝາະ ແລ້ວເບິ່ງບ່ອນທີ່ເຂົ້າກັນ",
    situationEmpty: "ຍັງບໍ່ໄດ້ຄັດສະຖານທີ່ສຳລັບສະຖານະການນີ້",
    situationSeeAll: "ເບິ່ງທັງໝົດ",
