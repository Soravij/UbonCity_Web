  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex h-9 items-center gap-2 rounded-lg border border-[#4B0150]/20 bg-white/55 px-3 text-[#4B0150] shadow-sm transition-all duration-300  hover:bg-gray-100 hover:shadow-[0_10px_20px_rgba(75,1,80,0.2)]"
