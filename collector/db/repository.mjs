...
export const PLACE_BACKWARD_PRODUCTION_TRANSITIONS = Object.freeze({
  ...
  writing_assigned: Object.freeze({
    ready_for_writer: Object.freeze({ direction: "in_process", label_th: "เปลี่ยนคนเขียน", surface: "assignment_review", publication_state: "draft", return_to_clean: true }),
    field_review: Object.freeze({ direction: "in_process", label_th: "ส่งกลับให้ field แก้", surface: "assignment_review", publication_state: "draft" }),
  }),
  ready_for_writer: Object.freeze({
    field_review: Object.freeze({ direction: "in_process", label_th: "ส่งกลับให้แก้", surface: "assignment_review", publication_state: "draft", return_to_clean: true }),
  }),
...
export function createRepository(db) {
  assertPlaceReviewFlagMigrationApplied(db, "creating Collector repository");
  assertAssignmentStateMigrationApplied(db, "creating Collector repository");
